...
hf download aiet2/dataset-combined-run --output-dir ./checkpoints/model1
hf download aiet2/dataset-100-run --output-dir ./checkpoints/model2
hf download aiet2/openarm-il-dataset-run --output-dir ./checkpoints/model3
hf download aiet2/dataset-quality-run --output-dir ./checkpoints/model4
hf download aiet2/dataset-clean-run --output-dir ./checkpoints/model5
